  ...
  async run() {
    ...
    const products = [
      ...
      },
      {
        ...
        price: 84.99,
        quantity: 12,
        imageFileName: 'metalica2.jpeg',
      },
      {
        name: 'Camisa ACDC',
        description: 'Camisa preta no material algodão - Banda ACDC.',
        price: 88.99,
        quantity: 40,
        imageFileName: 'acdc.webp',
      },
      {
        name: 'Moletom Pink Floyd',
        description: 'Casaco moletom preto no material algodão - Banda Pink Floyd.',
        price: 289.99,
        quantity: 20,
        imageFileName: 'PF.webp',
      },
      {
        name: 'Camisa The Beatles',
        description: 'Camisa preta no material algodão - Banda The Beatles.',
        price: 99.99,
        quantity: 60,
        imageFileName: 'TB.jpeg',
      },
      {
        name: 'Camisa Rolling Stones',
        description: 'Camisa cinza no material algodão - Banda Rolling Stones.',
        price: 69.99,
        quantity: 80,
        imageFileName: 'RS.webp',
      },
      {
        name: 'Camisa U2',
        description: 'Camisa PRETA no material algodão - Banda U2.',
        price: 59.99,
        quantity: 100,
        imageFileName: 'u2.jpeg',
      },
      {
        name: 'Camisa Led Zeppelin',
        description: 'Camisa BRANCA no material algodão - Banda Led Zeppelin.',
        price: 49.99,
        quantity: 200,
        imageFileName: 'LZ.webp',
      },
      {
        name: 'Camisa Iron Maiden',
        description: 'Camisa BRANCA no material algodão - Banda Iron Maiden.',
        price: 89.99,
        quantity: 100,
        imageFileName: 'IM.jpeg',
      },
    ]
